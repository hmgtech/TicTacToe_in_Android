...
public class OnlineGameActivity extends AppCompatActivity {
    ...
    void ShowAlert(String Title){
        View view = LayoutInflater.from(OnlineGameActivity.this).inflate(R.layout.custom_alert, null);
//        AlertDialog.Builder b = new AlertDialog.Builder(this, R.style.TransparentDialog);
        AlertDialog.Builder b = new AlertDialog.Builder(OnlineGameActivity.this);
        b.setTitle(Title)
                .setMessage("Click Menu to Return")
                .setView(view)
